---
name: run-pyright
description: Run basedpyright type checking via scripts/quality/pyright.sh for src, tests, and MCP. Use when fixing type errors or verifying typed API changes.

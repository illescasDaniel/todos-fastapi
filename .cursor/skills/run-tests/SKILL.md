---
name: run-tests
description: Run the project's pytest suite via scripts/run/tests.sh, including optional coverage. Use when running tests, verifying changes, or checking coverage after edits to src/todos_app/.

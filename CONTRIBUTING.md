...
Run `./scripts/run/checks.sh` before opening a pull request. Use `--fix` (or `./scripts/run/ruff.sh`) when you want Ruff to autofix/format; default gate mode is check-only.

...
# Re-apply schema with ./scripts/database/migrate.sh; optionally ./scripts/database/seed.sh for demo data.
...
source "$PROJECT_ROOT/scripts/container/internal/common.sh"
...
Use before a full reset; then run ./scripts/database/migrate.sh (and optionally ./scripts/database/seed.sh).
...
echo "Wipe complete. Next: ./scripts/database/migrate.sh (and optionally ./scripts/database/seed.sh or ./scripts/container/up.sh)"

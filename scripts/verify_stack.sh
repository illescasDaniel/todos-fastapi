...
# shellcheck source=scripts/verify/http.sh
source "$SCRIPT_DIR/verify/http.sh"
# shellcheck source=scripts/verify/bare_metal.sh
source "$SCRIPT_DIR/verify/bare_metal.sh"
# shellcheck source=scripts/verify/compose.sh
source "$SCRIPT_DIR/verify/compose.sh"
